      ...
      @endif
        <div class="contenedor-list">
            <div class="panel-heading">
                <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-list" aria-hidden="true"></i>&nbsp; Listado de Condiciones Laborales &nbsp;<i class="fa fa-list" aria-hidden="true"></i></h2>
            </div>
            <div class="panel-body">
	            ...
	            <div id="tablePanel">
	                <div class="row">
	                    <div class="col-md-8">
	                        <a href="{{route("condicionlaboralnuevo")}}">
	                            <button class="btn btn-sm btn-info" data-id=""><i class="fa fa-street-view"
	                                                          aria-hidden="true"></i> Nueva Condicion Laboral
	                            </button>
	                        </a>
	                    </div>
	                </div>
	            ...
	            <div class="table-responsive" id="lista-condicionlaboral">
                        <table class="table table-hover" id="tbl-condicionlaboral">
						  <thead>
						     <tr>
...
$(document).ready(function()
{
	...
	var gridtable= $('#tbl-condicionlaboral').bootgrid({
			ajax:true,
			labels: {
			...
			formatters: {
		        ...
		        "commands": function(column, row)
		        {
		            ...
		            return  "<a  class=\"btn \" href=\"../CondicionLaboral/Editar/" +   row.id + "\"><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>&nbsp; Editar</a>";
