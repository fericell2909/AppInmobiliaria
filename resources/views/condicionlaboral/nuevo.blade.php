...
@section('content')
    <!-- Content Header (Page header) -->
      ...
      @endif
                ...
                'id'=> 'RegistroCondicionLaboralForm','files' => true]) !!}
                <div class="panel-heading">
                    <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp; Registar Condicion Laboral &nbsp;<i class="fa fa-pencil-square-o" aria-hidden="true"></i></h2>
                </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" id = "btnRegistrarCondicionLaboral" class="btnRegistrarCondicionLaboral btn btn-principal btn-primary" >
                            <i class="fa fa-map-marker"></i> &nbsp;Registrar Condicion Laboral
                            </button>
                        </div>
...
<script>
	...
	$('#RegistroCondicionLaboralForm').on('submit', function (evt) {
  ...
  $('#RegistroCondicionLaboralForm').on('keypress', function (e) {
