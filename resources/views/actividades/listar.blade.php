      ...
      @endif
        <div class="contenedor-list">
            <div class="panel-heading">
                <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-tasks" aria-hidden="true"></i>&nbsp; Listado de Actividades &nbsp;<i class="fa fa-tasks" aria-hidden="true"></i></h2>
            </div>
            <div class="panel-body">
	            ...
	            <div id="tablePanel">
	                <div class="row">
	                    <div class="col-md-8">
	                        <a href="{{route("actividadesnuevo")}}">
	                            <button class="btn btn-sm btn-info" data-id=""><i class="fa fa-plus"
	                                                          aria-hidden="true"></i> Nuevo Actividad
	                            </button>
	                        </a>
	                    </div>
	                </div>
	            ...
	            <div class="table-responsive" id="lista-actividades">
                        <table class="table table-hover" id="tbl-actividades">
						  <thead>
						     <tr>
...
$(document).ready(function()
{
	...
	var gridtable= $('#tbl-actividades').bootgrid({
			ajax:true,
			labels: {
			...
			formatters: {
		        ...
		        "commands": function(column, row)
		        {
		            ...
		            return  "<a  class=\"btn \" href=\"../Actividades/Editar/" +   row.id + "\"><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>&nbsp; Editar</a>";
