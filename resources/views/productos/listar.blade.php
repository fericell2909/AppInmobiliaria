      ...
      @endif
        <div class="contenedor-list">
            <div class="panel-heading">
                <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-product-hunt" aria-hidden="true"></i>&nbsp; Listado de Productos &nbsp;<i class="fa fa-product-hunt" aria-hidden="true"></i></h2>
            </div>
            <div class="panel-body">
	            ...
	            <div id="tablePanel">
	                <div class="row">
	                    <div class="col-md-8">
	                        <a href="{{route("productosnuevo")}}">
	                            <button class="btn btn-sm btn-info" data-id=""><i class="fa fa-plus"
	                                                          aria-hidden="true"></i> Nuevo Producto
	                            </button>
	                        </a>
	                    </div>
	                </div>
	            ...
	            <div class="table-responsive" id="lista-productos">
                        <table class="table table-hover" id="tbl-productos">
						  <thead>
						     <tr>
...
$(document).ready(function()
{
	...
	var gridtable= $('#tbl-productos').bootgrid({
			ajax:true,
			labels: {
			...
			formatters: {
		        ...
		        "commands": function(column, row)
		        {
		            ...
		            return  "<a  class=\"btn \" href=\"../Productos/Editar/" +   row.id + "\"><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>&nbsp; Editar</a>";
