...
@section('content')
    <!-- Content Header (Page header) -->
      ...
      @endif
                ...
                {!! Form::open(['route' => 'productosguardar', 'class' => 'form','method' => 'POST','id'=> 'RegistroProductosForm','files' => true]) !!}
                <div class="panel-heading">
                    <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp; Registar Productos&nbsp;<i class="fa fa-pencil-square-o" aria-hidden="true"></i></h2>
                </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" id = "btnRegistrarProductos" class="btnRegistrarProductos btn btn-principal btn-primary" >
                            <i class="fa fa-plus"></i> &nbsp;Registrar Productos
                            </button>
                        </div>
...
<script>
	...
	$('#RegistroProductosForm').on('submit', function (evt) {
  ...
  $('#RegistroProductosForm').on('keypress', function (e) {
