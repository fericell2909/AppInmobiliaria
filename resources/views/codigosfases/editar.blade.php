...
@section('content')
    <!-- Content Header (Page header) -->
      ...
      @endif
                ...
                {!! Form::open(['route' => 'codigosfasesguardar', 'class' => 'form','method' => 'POST','id'=> 'EditarCodigoFaseForm','files' => true]) !!}
                <div class="panel-heading">
                    <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-pencil-square-o" aria-hidden="true">
                        </i>&nbsp; Editar Codigos de Fases&nbsp;<i class="fa fa-pencil-square-o" aria-hidden="true"></i></h2>
                </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-8">
                              ...
                              <input type="text" class="form-control text-center" id="descripcion" name="descripcion"  required
                                     maxlength="100" placeholder="Descripcion" value="{{ $codigosfases[0]->descripcion }}">
                                ...
                                <label class="color-azul">Estado</label>
                                    <select class="form-control text-center" name="estados_id" id="estados_id">
                                        @foreach($estados as $estado)
											@if( $codigosfases[0]->estados_id == $estado->id )
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" style="display:none;" class="form-control" name="id"  value="{{$codigosfases[0]->id}}">
                            <button type="submit" id = "btnEditarCodigoFase" class="btnEditarCodigoFase btn btn-principal btn-primary" >
                            <i class="fa fa-edit"></i> &nbsp;Editar Codigo de Fase
                            </button>
                        </div>
                    </div>
              {!! Form::close() !!}
...
<script>
	...
	$('#btnEditarCodigoFase').on('click', function (evt) {
    ...
    $('#EditarCodigoFaseForm').on('keypress', function (e) {
