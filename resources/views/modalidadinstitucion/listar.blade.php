...
@section('htmlheader_title')
    Listado de Modalidades de Instituciones
@endsection
@section('css-inicio')
      ...
      @endif
        <div class="contenedor-list">
            <div class="panel-heading">
                <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-list" aria-hidden="true"></i>&nbsp; Listado de Modalidades de Institucion &nbsp;<i class="fa fa-list" aria-hidden="true"></i></h2>
            </div>
            <div class="panel-body">
	            ...
	            <div id="tablePanel">
	                <div class="row">
	                    <div class="col-md-8">
	                        <a href="{{route("modalidadinstitucionnuevo")}}">
	                            <button class="btn btn-sm btn-info" data-id=""><i class="fa fa-street-view"
	                                                          aria-hidden="true"></i> Nuevo Modalidad de Institucion
	                            </button>
	                        </a>
	                    </div>
	                </div>
	            ...
	            <div class="table-responsive" id="lista-modalidades">
                        <table class="table table-hover" id="tbl-modalidadinstitucion">
						  <thead>
						     <tr>
...
$(document).ready(function()
{
	...
	var gridtable= $('#tbl-modalidadinstitucion').bootgrid({
			ajax:true,
			labels: {
			...
			url:"../ModalidadInstitucion/Listar",
			...
			formatters: {
		        ...
		        "commands": function(column, row)
		        {
		            ...
		            return  "<a  class=\"btn \" href=\"../ModalidadInstitucion/Editar/" +   row.id + "\"><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>&nbsp; Editar</a>";
