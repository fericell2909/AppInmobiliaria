...
@section('content')
    <!-- Content Header (Page header) -->
      ...
      @endif
                ...
                {!! Form::open(['route' => 'actividadesguardar', 'class' => 'form','method' => 'POST','id'=> 'RegistroActividadForm','files' => true]) !!}
                <div class="panel-heading">
                    <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp; Registar Actividades&nbsp;<i class="fa fa-pencil-square-o" aria-hidden="true"></i></h2>
                </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" id = "btnRegistrarActividades" class="btnRegistrarActividades btn btn-principal btn-primary" >
                            <i class="fa fa-plus"></i> &nbsp;Registrar Actividades
                            </button>
                        </div>
...
<script>
	...
	$('#RegistroActividadForm').on('submit', function (evt) {
  ...
  $('#RegistroActividadForm').on('keypress', function (e) {
