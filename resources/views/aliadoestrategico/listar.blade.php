...
@section('htmlheader_title')
    Listado de Aliados de Estrategicos
@endsection
@section('css-inicio')
      ...
      @endif
        <div class="contenedor-list">
            <div class="panel-heading">
                <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-list" aria-hidden="true"></i>&nbsp; Listado de Aliados Estrategicos &nbsp;<i class="fa fa-list" aria-hidden="true"></i></h2>
            </div>
            <div class="panel-body">
	            ...
	            <div id="tablePanel">
	                <div class="row">
	                    <div class="col-md-8">
	                        <a href="{{route("aliadoestrategiconuevo")}}">
	                            <button class="btn btn-sm btn-info" data-id=""><i class="fa fa-street-view"
	                                                          aria-hidden="true"></i> Nuevo Aliado Estrategico
	                            </button>
	                        </a>
	                    </div>
	                </div>
	            ...
	            <div class="table-responsive" id="lista-aliadoestrategico">
                        <table class="table table-hover" id="tbl-aliadoestrategico">
						  <thead>
						     <tr>
...
$(document).ready(function()
{
	...
	var gridtable= $('#tbl-aliadoestrategico').bootgrid({
			ajax:true,
			labels: {
			...
			formatters: {
		        ...
		        "commands": function(column, row)
		        {
		            ...
		            return  "<a  class=\"btn \" href=\"../AliadoEstrategico/Editar/" +   row.id + "\"><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>&nbsp; Editar</a>";
