...
@section('content')
    <!-- Content Header (Page header) -->
      ...
      @endif
                ...
                'id'=> 'RegistroAliadoEstrategicoForm','files' => true]) !!}
                <div class="panel-heading">
                    <h2 class="text-center titulo-ubicacion" style="font-weight:bold;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp; Registar Aliado Estrategico &nbsp;<i class="fa fa-pencil-square-o" aria-hidden="true"></i></h2>
                </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" id = "btnRegistrarAliadoEstrategico" class="btnRegistrarAliadoEstrategico btn btn-principal btn-primary" >
                            <i class="fa fa-map-marker"></i> &nbsp;Registrar Aliado Estrategico
                            </button>
                        </div>
...
<script>
	...
	$('#RegistroAliadoEstrategicoForm').on('submit', function (evt) {
  ...
  $('#RegistroAliadoEstrategicoForm').on('keypress', function (e) {
